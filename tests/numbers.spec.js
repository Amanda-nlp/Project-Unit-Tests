...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it("Verifica se a função `numbers`retorna `false` quando o array contém strings", () => {
    expect(false).toEqual(numbers([1, 2, '3', 4, 5]))
  });
    // Escreva um teste em que a função recebe [1, 'a', 3] e retorna false
  it("Verifica se a função `numbers`retorna `false` quando o array contém strings e letras", () => {
    expect(false).toEqual(numbers([1, 'a', 3]))
  });
    // Escreva um teste em que a função recebe [' '] e retorna false
  it("Verifica se a função `numbers`retorna `false` quando o array contém espaços vazios", () => {
